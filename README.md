...
> 🎬 **Live demo lives in a Streamlit UI** — see [How to run](#how-to-run) below,
> then scroll to the [Test case matrix](#test-case-matrix) section for a complete
> demo script with expected outcomes.
